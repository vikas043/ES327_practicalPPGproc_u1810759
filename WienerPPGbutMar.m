function PPGsigOut= WienerPPGbutMar()
clear all;
...
title({'Standardised Raw PPG signal','Subject 3'});
xlabel('Time (s)');
ylabel('PPG signal[-]');
figure();
plot(t,rawPPGav2);grid on;
title({'Raw PPG signal','Subject 3'});
xlabel('Time (s)');
...
title({'Standardized Detrended PPG signal','Subject 3'});
xlabel('Time (s)');
ylabel('PPG signal[-]');
figure();
plot(t,detPPGav2);grid on;
title({'Detrended PPG signal','Subject 3'});
xlabel('Time (s)');
ylabel('PPG signal[-]');
...
grid on;
title({'Standardized filtered PPG signal','Subject 3'});
xlabel('Time (s)'); 
ylabel('PPG signal[-]');
...
grid on;
title({'Filtered PPG signal','Subject 3'});
xlabel('Time (s)'); 
ylabel('PPG signal[-]');
...
grid on;
title({'Standardized processed PPG signal','Subject 3'})
xlabel('Time (s)');
ylabel('PPG signal [-]');
figure();
plot(t2,PPG_Clean);
...
grid on;
title({'Processed PPG signal','Subject 3'})
xlabel('Time (s)');
ylabel('PPG signal [-]');
xlim([5 45]);
...
plot(BPM_est);
grid on;
title({'BPM estimate comparison on standardization and normalization of signal','Subject 3'})
